...
kde-standard,plasma-desktop,plasma-workspace,sddm,kwin-x11,kinit,dolphin,konsole, \
plasma-framework,plasma-widgets-addons,plasma-desktop-data,libkf5plasma5,libkf5plasmaquick5, \
...
qml-module-org-kde-runnermodel,qml-module-org-kde-solid,qml-module-org-kde-kconfig, \
qml-module-org-kde-activities,qml-module-org-kde-bluezqt,qml-module-org-kde-kquickcontrols, \
libqt5svg5,libqt5gui5,breeze-icon-theme,desktop-file-utils, \
