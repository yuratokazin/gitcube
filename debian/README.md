Создание своего дистрибутива на базе Debian — это отличный способ получить систему «под себя». Самый современный и надежный инструмент для этого — Debian Live Build.

Вам понадобится установленный Debian (или Astra). 

Если это кажется слишком сложным, есть инструменты попроще:
