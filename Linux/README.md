...
## Дерево каталогов операционной системы Linux
...
bin (binary) хранит основные исполняемые файлы команд (ls, cp, cat)
etc (et cetera) содержит конфигурационные файлы для настройки операционной системы и установленных программ
home — домашние каталоги пользователей
dev (от devices) хранит специальные файлы интерфейсов оборудования (драйверов)
usr (от User System Resources) содержит пользовательские программы
...
- `sudo apt purge <имя_пакета>` — для полного удаления программы, включая её исполняемые файлы и системные конфигурационные файлы.

Пример: установка текстового редактора `nano` и IDE Geany:
